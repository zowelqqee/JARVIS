...
PLANNER_PROMPT = """You are the planning module of JARVIS (Just A Rather Very Intellegent System), a personal AI assistant.
...
def _fallback_plan(goal: str) -> dict:
    print("[Planner] [RELOAD] Fallback plan")
    return {
        "goal": goal,
        "steps": [
            {
...
Create a REVISED plan for the remaining work only. Do not repeat completed steps."""
    ...
    try:
        ...
        print(f"[Planner] [RELOAD] Revised plan: {len(plan['steps'])} steps")
        return plan
    except Exception as e:
